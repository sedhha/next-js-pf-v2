...
const workExperience = [
    {
        id: '0',
        org: 'MitraTech Holdings Inc.',
        designation: 'Software Engineer IV',
        startDate: 1744655400000,
        current: true,
        img: 'https://images.ctfassets.net/eowwrv5buqcq/2T2Dh4nNVuFj5SayOEHwqN/ed9d16d1d97944299b9f5ba98ff289fc/mitratech_logo.jpeg', // placeholder
        description:
            'Working on building next-generation agentic frameworks using the Agent Development Kit, while also designing secure and encrypted response storage systems for conversational agents. Alongside this, I focus on optimizing and enhancing UI in a micro-frontend framework, ensuring it can seamlessly support multiple host applications.',
        technologies: [
            'React',
            'Node.js',
            'Vite',
    ...
    },
    {
        ...
        endDate: 1744655400000,
        img: 'https://images.ctfassets.net/eowwrv5buqcq/1xb9H5lExwcaL13gUhnoS3/30e19fa82c2273dcb3ad7429e42ebe64/tg_logo.png',
        description:
            'Working as a Scala Developer for Apple Maps team, I am working on multiple Scala and Java based microservices. These services involve interaction with Big Data using Spark, CI/CD pipelines, and managing binary blob storage and retrieval services at scale.',
        technologies: [
            'Scala',
            'Java',
            'Apache Spark',
    ...
    },
    {
        ...
        description:
            'Working as a Software Engineer, I have majorly been involved in making end to end applications using React and Scala as a backend service. Building microservices and creating CI/CD workflow pipeline.',
    ...
    },
    {
        ...
        description:
            'My major focus was upon building scalable applications, analytics web dashboards and automated alert chat-bots. Built AdCampaign Automation tools for digital marketing optimization.',
        technologies: [
            'JavaScript',
            'Analytics',
            'Chatbots',
...
function WorkCard({ work }: { work: (typeof workExperience)[0] }) {
    const isActive = work.current;

    return (
        <div
            className={`group relative bg-black/40 backdrop-blur-sm rounded-xl p-6 transition-all duration-500 hover:bg-black/60 h-full ${isActive
                ? 'border-2 border-emerald-400/80 shadow-lg shadow-emerald-500/20'
        ...
        >
            ...
            <div className="space-y-3">
                ...
                <div>
                    <h3
                        className={`text-lg font-bold transition-colors duration-300 line-clamp-1 ${isActive ? 'text-emerald-300' : 'text-gray-200 group-hover:text-cyan-300'
                            }`}
                    >
                        {work.org}
                    </h3>
                    <h4
                        className={`text-sm font-medium mt-1 line-clamp-2 ${isActive
                            ? 'text-emerald-200/80'
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                        Shaping impactful solutions across organizations while evolving as a developer.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-400">
                            Current Role{stats.currentRoles !== 1 ? 's' : ''}
                        </p>
                    </div>
                    <div className="text-center">
