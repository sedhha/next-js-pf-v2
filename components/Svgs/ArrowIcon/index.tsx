...
const NavigateLeft = ({ fillColor, ...props }: Props) => (
	<svg
		width={80}
		height={128}
		viewBox="0 0 80 128"
	...
	>
		...
		<path
			fillRule="evenodd"
			clipRule="evenodd"
			d="M57.5533 63.6667H38.6666L79.3333 105.333V85.982L57.5533 63.6667ZM79.3333 22L38.6666 63.6667H57.5533L79.3333 41.3513V22Z"
			fill={fillColor ?? '#F27304'}
		/>
	</svg>
);
