...
export const sendEmailNewsLetterToUsers = (emailProps: ISendEmail) => fetch(appScriptUri, {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json'
    },
    body: JSON.stringify({ apiKey: process.env.APPSCRIPT_API_KEY, opType: 'email', opProps: emailProps })
}).then(async (res) => {
