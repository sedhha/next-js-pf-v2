  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Floating Elements */}
        <div className="absolute top-20 left-10 w-3 h-3 bg-red-400/60 rounded-full animate-bounce delay-0 shadow-lg shadow-red-400/30" />
        <div className="absolute top-40 right-20 w-2 h-2 bg-orange-400/80 rounded-full animate-bounce delay-500 shadow-lg shadow-orange-400/30" />
        <div className="absolute bottom-32 left-1/3 w-4 h-4 bg-yellow-400/70 rounded-full animate-bounce delay-1000 shadow-lg shadow-yellow-400/30" />

        {/* Gradient orbs */}
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[radial-gradient(var(--tw-gradient-stops))] from-red-500/20 via-red-500/10 to-transparent rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-[radial-gradient(var(--tw-gradient-stops))] from-orange-500/15 via-orange-500/8 to-transparent rounded-full blur-3xl animate-pulse delay-2000" />
      </div>

      <div className="max-w-2xl mx-auto text-center relative z-10">
        {/* 404 Animation */}
        <div className="mb-8">
          <div className="text-8xl sm:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 animate-pulse">
            404
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Link 
            href="/portfolio-blog"
            className="group flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-red-500 to-orange-500 text-black font-bold hover:scale-105 transition-all duration-300 shadow-lg shadow-red-500/30"
          >
